...
func (app *application) GetPaymentIntent(w http.ResponseWriter, r *http.Request) {
	...
	if okay {
		_ = app.writeJSON(w, http.StatusOK, pi)
	} else {
		j := jsonResponse{
			OK:      false,
			Message: msg,
		...
		_ = app.writeJSON(w, http.StatusInternalServerError, j)
	}
}
...
func (app *application) GetWidgetByID(w http.ResponseWriter, r *http.Request) {
	...
	_ = app.writeJSON(w, http.StatusOK, widget)
}
...
func (app *application) CreateAuthToken(w http.ResponseWriter, r *http.Request) {
	...
	payload.Error = false
	payload.Message = fmt.Sprintf("token for %f created", userInput.Email)
	payload.Token = token
...
func (app *application) OneUser(w http.ResponseWriter, r *http.Request) {
	...
	user, err := app.DB.GetOneUsers(userID)
	if err != nil {
		app.badRequest(w, r, err)
		return
	}
