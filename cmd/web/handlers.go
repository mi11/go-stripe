...
func (app *application) GetTransactionData(r *http.Request) (TransactionData, error) {
	...
	card := cards.Card{Secret: app.config.stripe.secret, Key: app.config.stripe.key}
...
// PaymentSucceeded displays the payment information
...
// VirtualTerminalPaymentSucceeded displays the payment information for virtual terminal transactions
...
// OneUser shows an admin user for add/edit/delete
